...
Una vez conocidas las provincias con climatología más adversa para cada año del periodo 2010-2019, comprobar si la morbilidad hospitalaria y la mortalidad por ECV fue significativamente mayor en las provincias con una mayor climatología adversa.
...
- Cargar las tablas de información meteorológica mensual para cada provincia empleando el paquete climaemet.
...
- Filtrar cada dataframe para que únicamente contenga la información de cada año y mes referente a: temperatura media de las máximas, temperatura media de las mínimas, presión máxima absoluta, presión mínima absoluta, humedad relativa y porcentaje medio mensual de la insolación diaria frente a la insolación teórica.

- Comparar las variables meteorológicas de una misma provincia entre los diferentes meses y años y seleccionar los meses de cada provincia que fueran meteorológicamente adversos, empleando para ello la anomalía de cada variable meteorológica.

- Aquellos meses de cada provincia que sean más adversos, almacenarlos en un dataframe todos juntos.
...
- Descargar todos los archivos en formato .xlsx que contienen la información relativa a morbilidad hospitalaria y causas de defunción desde 2010 a 2019 a través de la página INEBase.

- Combinar dichos archivos mediante R para obtener 2 dataframes (uno de morbilidad y uno de mortalidad).
...
- Combinar los dataframes de morbilidad y mortalidad con el dataframe de meteorología adversa, y representar en una gráfica la climatología frente a la morbilidad y en otra gráfica la climatología frente a la mortalidad.
...
- Obtener un dataframe que contenga los datos de mortalidad a nivel anual clasificada por meses y año. 

- Filtrar dicho dataframe para que únicamente contenga la información referente al número de muertes por Enfermedades del sistema circulatorio (053-061) en cada mes de dicho año.
...
- Combinar este dataframe con el dataframe de meteorología y graficar la relación.
...
<center>
<figure>
<img src="IMAGENES/Aspecto fichero csv.jpg" alt="an image">
...
<figcaption>Dataframe de morbilidad </figcaption>
</figure>
...
<div style="text-align: justify">
La realización de la gráfica correspondiente a graf_presion es muy similar a graf_temp, modificando únicamente el parámetro pasado en cada uno de los geom. El código empleado para ello es el siguiente:
...
Siendo el resultado obtenido la siguente gráfica:

<center>
<figure>
<img src="OUTPUT/A_Coruna_Presion.png">
